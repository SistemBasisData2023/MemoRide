          ...
          <Row>
            <Col lg="6">
              <div className="content">
                ...
                <h1>
                  Culture is not about the history,
                  <br></br>
                  <span className="highlight"> it's about life!</span>
                </h1>
                <p>
                  We believe that culture is not just about{" "}
                  <span>the past</span>; <br></br>it's about{" "}
                  <span>embracing life</span> and immersing yourself in
                  authentic experiences.
                  <br />
                  <span>Join us</span> and create unforgettable memories in your
                  whole life!
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="3">
              ...
              <h2 className="services_title">
                MemoRide <span className="highlight">always</span> with users.
              </h2>
            </Col>
            <ServiceList />
          </Row>
